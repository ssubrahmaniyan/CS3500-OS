...
cat(int fd)
{
  ...
  3c:	8c858593          	addi	a1,a1,-1848 # 900 <malloc+0xea>
  40:	4509                	li	a0,2
  ...
  62:	8ba58593          	addi	a1,a1,-1862 # 918 <malloc+0x102>
  66:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
  ...
  d6:	85e58593          	addi	a1,a1,-1954 # 930 <malloc+0x11a>
  da:	4509                	li	a0,2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 422:	0805c663          	bltz	a1,4ae <printint+0x9e>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 436:	51e50513          	addi	a0,a0,1310 # 950 <digits>
 43a:	883a                	mv	a6,a4
 ...
 46c:	fef70423          	sb	a5,-24(a4)
 470:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
 474:	02e05663          	blez	a4,4a0 <printint+0x90>
 478:	fb840793          	addi	a5,s0,-72
 ...
 494:	8526                	mv	a0,s1
 496:	f5dff0ef          	jal	ra,3f2 <putc>
  while(--i >= 0)
 49a:	197d                	addi	s2,s2,-1
 49c:	ff391ae3          	bne	s2,s3,490 <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 584:	855a                	mv	a0,s6
 586:	e8bff0ef          	jal	ra,410 <printint>
 58a:	8bca                	mv	s7,s2
      state = 0;
 58c:	4981                	li	s3,0
 ...
 5a8:	85d6                	mv	a1,s5
 5aa:	855a                	mv	a0,s6
 5ac:	e47ff0ef          	jal	ra,3f2 <putc>
        putc(fd, c0);
 5b0:	85ca                	mv	a1,s2
 5b2:	855a                	mv	a0,s6
 5b4:	e3fff0ef          	jal	ra,3f2 <putc>
      state = 0;
 5b8:	4981                	li	s3,0
 ...
 5c8:	855a                	mv	a0,s6
 5ca:	e47ff0ef          	jal	ra,410 <printint>
        i += 1;
 ...
 5f2:	855a                	mv	a0,s6
 5f4:	e1dff0ef          	jal	ra,410 <printint>
        i += 2;
 ...
 60c:	855a                	mv	a0,s6
 60e:	e03ff0ef          	jal	ra,410 <printint>
        i += 2;
 ...
 626:	855a                	mv	a0,s6
 628:	de9ff0ef          	jal	ra,410 <printint>
 62c:	8bca                	mv	s7,s2
      state = 0;
 62e:	4981                	li	s3,0
 ...
 63e:	855a                	mv	a0,s6
 640:	dd1ff0ef          	jal	ra,410 <printint>
        i += 1;
 ...
 658:	855a                	mv	a0,s6
 65a:	db7ff0ef          	jal	ra,410 <printint>
        i += 2;
 ...
 672:	855a                	mv	a0,s6
 674:	d9dff0ef          	jal	ra,410 <printint>
 678:	8bca                	mv	s7,s2
      state = 0;
 67a:	4981                	li	s3,0
 ...
 68a:	855a                	mv	a0,s6
 68c:	d85ff0ef          	jal	ra,410 <printint>
        i += 1;
 ...
 6a8:	855a                	mv	a0,s6
 6aa:	d49ff0ef          	jal	ra,3f2 <putc>
  putc(fd, 'x');
 6ae:	07800593          	li	a1,120
 6b2:	855a                	mv	a0,s6
 6b4:	d3fff0ef          	jal	ra,3f2 <putc>
 6b8:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 704:	24890913          	addi	s2,s2,584 # 948 <malloc+0x132>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 8ca:	ec5ff0ef          	jal	ra,78e <free>
  return freep;
 8ce:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 8d2:	dd61                	beqz	a0,8aa <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8d4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 8d6:	4798                	lw	a4,8(a5)
 8d8:	fa9777e3          	bgeu	a4,s1,886 <malloc+0x70>
    if(p == freep)
 8dc:	00093703          	ld	a4,0(s2)
 8e0:	853e                	mv	a0,a5
 8e2:	fef719e3          	bne	a4,a5,8d4 <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
 8e6:	8552                	mv	a0,s4
 8e8:	af3ff0ef          	jal	ra,3da <sbrk>
  if(p == (char*)-1)
 8ec:	fd551ce3          	bne	a0,s5,8c4 <malloc+0xae>
        return 0;
 8f0:	4501                	li	a0,0
 8f2:	bf65                	j	8aa <malloc+0x94>
