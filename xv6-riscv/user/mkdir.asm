...
main(int argc, char *argv[])
{
  ...
  3e:	84658593          	addi	a1,a1,-1978 # 880 <malloc+0xec>
  42:	4509                	li	a0,2
  ...
  54:	84858593          	addi	a1,a1,-1976 # 898 <malloc+0x104>
  58:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 47a:	44ac8c93          	addi	s9,s9,1098 # 8c0 <digits>
 ...
 682:	23a90913          	addi	s2,s2,570 # 8b8 <malloc+0x124>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 848:	ec5ff0ef          	jal	ra,70c <free>
  return freep;
 84c:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 850:	dd61                	beqz	a0,828 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 852:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 854:	4798                	lw	a4,8(a5)
 856:	fa9777e3          	bgeu	a4,s1,804 <malloc+0x70>
    if(p == freep)
 85a:	00093703          	ld	a4,0(s2)
 85e:	853e                	mv	a0,a5
 860:	fef719e3          	bne	a4,a5,852 <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
 864:	8552                	mv	a0,s4
 866:	af3ff0ef          	jal	ra,358 <sbrk>
  if(p == (char*)-1)
 86a:	fd551ce3          	bne	a0,s5,842 <malloc+0xae>
        return 0;
 86e:	4501                	li	a0,0
 870:	bf65                	j	828 <malloc+0x94>
