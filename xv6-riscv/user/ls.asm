...
ls(char *path)
{
 ...
 104:	9b050513          	addi	a0,a0,-1616 # ab0 <malloc+0x11c>
 ...
 13a:	94a58593          	addi	a1,a1,-1718 # a80 <malloc+0xec>
 13e:	4509                	li	a0,2
 ...
 14c:	95058593          	addi	a1,a1,-1712 # a98 <malloc+0x104>
 150:	4509                	li	a0,2
 ...
 172:	95250513          	addi	a0,a0,-1710 # ac0 <malloc+0x12c>
 ...
 1ac:	908a0a13          	addi	s4,s4,-1784 # ab0 <malloc+0x11c>
        printf("ls: cannot stat %s\n", buf);
 1b0:	00001a97          	auipc	s5,0x1
 1b4:	8e8a8a93          	addi	s5,s5,-1816 # a98 <malloc+0x104>
...
main(int argc, char *argv[])
{
 ...
 256:	88650513          	addi	a0,a0,-1914 # ad8 <malloc+0x144>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 5b4:	53850513          	addi	a0,a0,1336 # ae8 <digits>
 5b8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 67a:	472c8c93          	addi	s9,s9,1138 # ae8 <digits>
 ...
 882:	26290913          	addi	s2,s2,610 # ae0 <malloc+0x14c>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 a48:	ec5ff0ef          	jal	ra,90c <free>
  return freep;
 a4c:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 a50:	dd61                	beqz	a0,a28 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a52:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 a54:	4798                	lw	a4,8(a5)
 a56:	fa9777e3          	bgeu	a4,s1,a04 <malloc+0x70>
    if(p == freep)
 a5a:	00093703          	ld	a4,0(s2)
 a5e:	853e                	mv	a0,a5
 a60:	fef719e3          	bne	a4,a5,a52 <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
 a64:	8552                	mv	a0,s4
 a66:	af3ff0ef          	jal	ra,558 <sbrk>
  if(p == (char*)-1)
 a6a:	fd551ce3          	bne	a0,s5,a42 <malloc+0xae>
        return 0;
 a6e:	4501                	li	a0,0
 a70:	bf65                	j	a28 <malloc+0x94>
